...
const CreatePreMedical = ({ auth, countries, agencies }) => {
                        ...
                        <div className="space-y-3 mt-[14px]">
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    value={
                                        countryOptions.find(
                                            (opt) => opt.value === data.country_code
                                        ) || null
                                    }
                                    onChange={(option) => {
                                        setData("country_code", option?.value || "");
                                        setData("country_name", option?.name || "");
                                    }}
                                    placeholder="Select Country"
                                />
                                {errors.country_code && (
                                    <p className="text-red-500">{errors.country_code}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    value={data.father_name.toUpperCase()}
                                    onChange={(e) =>
                                        setData("father_name", e.target.value.toUpperCase())
                                    }
                                    className="w-full border rounded px-2 py-1"
                                />
                            </div>
