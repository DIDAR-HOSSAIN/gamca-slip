...
export default function MedicalExaminationForm({ receipt }) {
    ...
    const cell = "border border-black text-sm align-middle font-bold";
    const val = "border border-black text-sm w-56 text-center align-middle";

    return (
        <div className="min-h-screen">
            <div className="a4-page w-[210mm] mx-auto bg-white">
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-center">
                        ...
                        <p>Mobile: +8801883077569 | GCC Code: 05/02/23</p>
                        <h2 className="font-bold underline my-2 text-base">
                ...
                <table className="w-full mb-3 border border-black">
                    <tbody className="[&>tr>td]:py-1 [&>tr>td]:px-2">
                        ...
                        <tr>
                            <td className={cell}>SGPT
                            </td>
                            <td className={`${val} text-left`}>

                            </td>

                            <td className={cell}>SGOT</td>
                            <td className={`${val} text-left`}>
                            </td>
                            <td className={cell}>S.Bilirubin</td>
                            <td className={`${val} text-left`}>
                ...
                <table className="w-full border border-gray-400">
                    <thead>
                        <tr className="bg-gray-100">
                            <th className="border p-2 w-1/2">Medical Officer Comments</th>
                            <th className="border p-2 w-1/2">Clinical Pathologist</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td className="border p-4 h-48"></td>
                            <td className="border p-4 h-48"></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table style={{ width: "100%", textAlign: "center" }}>
                    <tbody>
                        <tr>
                            <td style={{ width: "33%", paddingTop: "40px" }}>
