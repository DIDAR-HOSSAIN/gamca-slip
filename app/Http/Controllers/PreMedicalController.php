...
class PreMedicalController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:pre-medical-money-receipt', ['only' => ['premedicalMoneyReceipt']]);
    ...
    public function create()
    {
        ...
        $agencies = Agency::select('id', 'agency_id', 'agency_name')->get();
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'religion'          => 'required|in:Islam,Hinduism,Christianity,Sikh,Bhuddism,Others,N/A',
