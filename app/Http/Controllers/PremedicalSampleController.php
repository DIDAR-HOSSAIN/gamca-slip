...
class PremedicalSampleController extends Controller
{
    ...
    {
        $this->middleware('permission:pre-medical-sample-list|pre-medical-sample-create|pre-medical-sample-edit|pre-medical-sample-delete', ['only' => ['index', 'store']]);
        $this->middleware('permission:pre-medical-sample-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:pre-medical-sample-edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:pre-medical-sample-delete', ['only' => ['destroy']]);
    }
